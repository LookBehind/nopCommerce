...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageDeliveryScheduler = new PermissionRecord { Name = "Admin area. Manage Delivery Scheduler", SystemName = "ManageDeliveryScheduler", Category = "Order" };
