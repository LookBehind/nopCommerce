...
namespace Nop.Plugin.Company.Company.Components
{
    ...
    public class GlobalDeliveryTimeValidationViewComponent(
        ...
        : NopViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Plugins/Company.Company/Views/Shared/Components/GlobalDeliveryTimeValidation/Default.cshtml", model);
        }
